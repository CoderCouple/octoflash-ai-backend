"""Organization — billing boundary and the root of multi-tenancy.

An org owns workspaces and (via Subscription) carries the Stripe customer +
plan. Users join an org through OrgMembership, which carries their role.
`plan` is denormalized from Subscription for fast reads on hot paths.
"""
