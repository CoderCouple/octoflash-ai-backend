...
automatically when awaited from async service methods.
"""
...
def create_customer(
    name: str, email: str | None = None, metadata: dict | None = None
) -> str:
...
def list_invoices(customer_id: str, limit: int = 20) -> list[dict]:
    """List recent invoices for a customer, simplified."""
    _configure()
